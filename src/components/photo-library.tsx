...
// Photo library data
const photoItems = [
  { id: "photolog-1", label: "PhotoLog1", image: "/images/PhotoLog1.jpg", coordinates: "47.6055° N, 122.3298° W", location: "Field Station Alpha", date: "2157.03.14", time: "14:20:00", color: "#7A6B5E" },
