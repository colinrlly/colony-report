...
const photoItems = [
  ...
  { id: "photolog-2", label: "img.2", image: "/images/PhotoLog2.jpg", coordinates: "47.6062° N, 122.3321° W", location: "Mushroom Forest", date: "2157.03.14", time: "14:23:07", color: "#8B7355" },
