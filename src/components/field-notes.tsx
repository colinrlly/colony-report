    ...
    >
      <WindowTitleBar className="h-[36px]">
        <div className="flex items-center gap-2">
          ...
          <InfoTooltip label="Field notes info">Notes and drawings collected by the Formica team while out in the field and scanned in here for research collection</InfoTooltip>
        </div>
