...
export function ColonyReports({ onClose, onMinimize }: ColonyReportsProps) {
  ...
  return (
    <Window resizable={false} leftSnapBoundary={ICON_COLUMN_RIGHT_EDGE} className="aspect-[11/8.5] max-w-[calc(100vw-16px)] w-auto h-[calc(100vh-92px)] absolute top-[44px] left-1/2 -translate-x-1/2 flex flex-col">
      <WindowTitleBar>
